...
use TDW\ACiencia\Controller\Association\{AssociationCommandController,
...
{
    /** @var string Path para la gestión de associations */
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::assertNotEmpty($website);
        self::$association  = AssociationFactory::createAssociation($associationName,$website);
    ...
    public function testGetAssociationsTag(): void
    {
        self::assertSame(
...
// ==============================================================================================
    /**
     * PUT /associations/{associationId}/entity/add/{stuffId}
     */
...
// ==============================================================================================
    ...
    public function testGetEntity200OkEmpty(): void
    {
        $response = $this->runApp(
            'GET',
            self::RUTA_API . '/' . self::$association->getId() . '/entities',
