...
class BaseTestCase extends TestCase
{
    ...
    public function runApp(
        ...
        if (!isset($requestHeaders['Content-Type']) || $requestHeaders['Content-Type'] === 'application/x-www-form-urlencoded') {
            ...
            if (is_array($requestData)) {
                $requestData = (string) json_encode($requestData, JSON_PARTIAL_OUTPUT_ON_ERROR);
            }
