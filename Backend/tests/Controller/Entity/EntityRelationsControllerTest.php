...
use TDW\ACiencia\Entity\{Association, Entity, Person, Product};
use TDW\ACiencia\Factory\{AssociationFactory, EntityFactory, PersonFactory, ProductFactory};
...
final class EntityRelationsControllerTest extends BaseTestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        $associationWebsite = self::$faker->url();
        self::assertNotEmpty($associationName);
        self::assertNotEmpty($associationWebsite);
        self::$association  = AssociationFactory::createAssociation($associationName, $associationWebsite);
    ...
    public function testGetAssociation200OkWithElements(): void
    {
        self::$reader['authHeader'] = $this->getTokenHeaders(self::$reader['username'], self::$reader['password']);
        $response = $this->runApp(
            'GET',
     ...
     * @throws JsonException
     */
    #[TestsAttr\Depends('testGetAssociation200OkWithElements')]
